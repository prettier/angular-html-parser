...
* **core:** Angular directives, components and pipes are now standalone by default. Specify  for declarations that are currently declared in s.  for v19 will take care of this automatically.
* **compiler:** `this.foo` property reads no longer refer to template context variables. If you intended to read the template variable, do not use `this.`.

### Features

* **common:** add optional rounded transform support in cloudinary image loader ([#55364](https://github.com/prettier/angular-html-parser/issues/55364)) ([24c6373](https://github.com/prettier/angular-html-parser/commit/24c6373820231faf9d012a2e4d7ea945d3e8513b))
* **common:** disable keyvalue sorting using null compareFn ([#57487](https://github.com/prettier/angular-html-parser/issues/57487)) ([13c1306](https://github.com/prettier/angular-html-parser/commit/13c13067bc3ed50cb80b0a86e62655448adb3051))
* **common:** expose component instance in NgComponentOutlet ([#58698](https://github.com/prettier/angular-html-parser/issues/58698)) ([e4c50b3](https://github.com/prettier/angular-html-parser/commit/e4c50b3bea22ca2afba74465893c36730952f4b9))
* **compiler-cli:** generate the HMR replacement module ([#58205](https://github.com/prettier/angular-html-parser/issues/58205)) ([231e6ff](https://github.com/prettier/angular-html-parser/commit/231e6ff6ca0dae0289a03615bcaed29455c2d4b8))
* **compiler:** add support for the `typeof` keyword in template expressions. ([#58183](https://github.com/prettier/angular-html-parser/issues/58183)) ([0c9d721](https://github.com/prettier/angular-html-parser/commit/0c9d721ac157662b2602cf0278ba4b79325f6882))
* **core:** Add incremental hydration public api ([#58249](https://github.com/prettier/angular-html-parser/issues/58249)) ([69fc5ae](https://github.com/prettier/angular-html-parser/commit/69fc5ae9229b872a9ad70eb920087af2a378fead))
* **core:** Add rxjs operator prevent app stability until an event ([#56533](https://github.com/prettier/angular-html-parser/issues/56533)) ([8ebbae8](https://github.com/prettier/angular-html-parser/commit/8ebbae88ca48b8aa78cd85deedbed19d44b8227e))
* **core:** add syntactic sugar for initializers ([#53152](https://github.com/prettier/angular-html-parser/issues/53152)) ([19edf2c](https://github.com/prettier/angular-html-parser/commit/19edf2c057f7587bc16812685d31a556521ad414))
* **core:** allow running output migration on a subset of paths ([#58299](https://github.com/prettier/angular-html-parser/issues/58299)) ([ab25a19](https://github.com/prettier/angular-html-parser/commit/ab25a192ba664863ad68d224b9b2df78da22769a))
* **core:** experimental `resource()` API for async dependencies ([#58255](https://github.com/prettier/angular-html-parser/issues/58255)) ([18d8d44](https://github.com/prettier/angular-html-parser/commit/18d8d44b1f3d56a4eda68f2cafded7529e08d0f1))
* **core:** experimental impl of `rxResource()` ([#58255](https://github.com/prettier/angular-html-parser/issues/58255)) ([9762b24](https://github.com/prettier/angular-html-parser/commit/9762b24b5e8d7ab3ed2321959492a77b01d8ae57))
* **core:** flipping the default value for `standalone` to `true` ([#58169](https://github.com/prettier/angular-html-parser/issues/58169)) ([6b8c494](https://github.com/prettier/angular-html-parser/commit/6b8c494d05e545830fffb9626153480af6339ddc))
* **core:** introduce debugName optional arg to framework signal functions ([#57073](https://github.com/prettier/angular-html-parser/issues/57073)) ([ec386e7](https://github.com/prettier/angular-html-parser/commit/ec386e7f1216e0047392e75ab686b310b073eb42))
* **core:** introduce the reactive linkedSignal ([#58189](https://github.com/prettier/angular-html-parser/issues/58189)) ([8311f00](https://github.com/prettier/angular-html-parser/commit/8311f00faaf282d1a5b1ddca29247a2fba94a692)), closes [#55673](https://github.com/prettier/angular-html-parser/issues/55673)
* **core:** promote `outputFromObservable` & `outputToObservable` to stable. ([#58214](https://github.com/prettier/angular-html-parser/issues/58214)) ([3f1e7ab](https://github.com/prettier/angular-html-parser/commit/3f1e7ab6ae984149004c449c04301b434ea64d2a))
* **core:** Promote `takeUntilDestroyed` to stable. ([#58200](https://github.com/prettier/angular-html-parser/issues/58200)) ([97c44a1](https://github.com/prettier/angular-html-parser/commit/97c44a1d6c41be250d585fba5af2bc2af4d98ae2))
* **core:** treat directives, pipes, components as  by default ([#58229](https://github.com/prettier/angular-html-parser/issues/58229)) ([819ff03](https://github.com/prettier/angular-html-parser/commit/819ff034ce7cf014cedef60510b83af9340efa71))
* **forms:** add ability to clear a FormRecord ([#50750](https://github.com/prettier/angular-html-parser/issues/50750)) ([3e7d724](https://github.com/prettier/angular-html-parser/commit/3e7d724037cca4d256b1442eda20d6c6ad91d279))
* **http:** promote `withRequestsMadeViaParent` to stable. ([#58221](https://github.com/prettier/angular-html-parser/issues/58221)) ([4b9accd](https://github.com/prettier/angular-html-parser/commit/4b9accdf166f3990b3706de83ada15937fe786e2)), closes [#55652](https://github.com/prettier/angular-html-parser/issues/55652) [#58212](https://github.com/prettier/angular-html-parser/issues/58212)
* **language-service:** support converting to signal queries in VSCode extension ([#58106](https://github.com/prettier/angular-html-parser/issues/58106)) ([bc83fc1](https://github.com/prettier/angular-html-parser/commit/bc83fc1e2ebac1a99b6e8ed63cea48f48dd7c863))
* **language-service:** support migrating full classes to signal queries ([#58263](https://github.com/prettier/angular-html-parser/issues/58263)) ([6342bef](https://github.com/prettier/angular-html-parser/commit/6342befff8ee491f37e8912cccb0099bbbf01042))
* **migrations:** add a combined migration for all signals APIs ([#58259](https://github.com/prettier/angular-html-parser/issues/58259)) ([dff4de0](https://github.com/prettier/angular-html-parser/commit/dff4de0f75741bc629462bb8da833b876c754453))
* **migrations:** capture output migration stats ([#58321](https://github.com/prettier/angular-html-parser/issues/58321)) ([bb286f6](https://github.com/prettier/angular-html-parser/commit/bb286f65e7a38c21ae61807b9a7811908a9030ed))
* **migrations:** expose output as function migration ([#58299](https://github.com/prettier/angular-html-parser/issues/58299)) ([2bfc64d](https://github.com/prettier/angular-html-parser/commit/2bfc64daf1cad9be8099759e8de7a361555ad5d1))
* **migrations:** print output migration stats in ng generate ([#58321](https://github.com/prettier/angular-html-parser/issues/58321)) ([cf70d62](https://github.com/prettier/angular-html-parser/commit/cf70d626cdedfd978d058b973420d8f31980555d))
* **service-worker:** allow specifying maxAge for entire application ([#49601](https://github.com/prettier/angular-html-parser/issues/49601)) ([8ddce80](https://github.com/prettier/angular-html-parser/commit/8ddce80a0bab4ebbd0f7db1c85ee27e4f0249db9))
* **service-worker:** finish implementation of refreshAhead feature ([#53356](https://github.com/prettier/angular-html-parser/issues/53356)) ([1479af9](https://github.com/prettier/angular-html-parser/commit/1479af978cd2bbe4ee9f1ca9682684b8e5135fa7)), closes [#46729](https://github.com/prettier/angular-html-parser/issues/46729)


### Bug Fixes

* **bazel:** allow strictStandalone to be passed through tsconfig ([#58683](https://github.com/prettier/angular-html-parser/issues/58683)) ([ff71af7](https://github.com/prettier/angular-html-parser/commit/ff71af7f02da6689b5c9c95bb7a2286bdc34bfbb))
* **compiler-cli:** correct extraction of generics from type aliases ([#58548](https://github.com/prettier/angular-html-parser/issues/58548)) ([d271c44](https://github.com/prettier/angular-html-parser/commit/d271c4422aee15a195d3ed796c191e8acac9e219))
* **compiler-cli:** disable standalone by default on older versions of Angular ([#58405](https://github.com/prettier/angular-html-parser/issues/58405)) ([2f9af91](https://github.com/prettier/angular-html-parser/commit/2f9af914b7d8173e852171c620d17980ae9bf6fc))
* **compiler-cli:** do not fail fatal when references to non-existent module are discovered ([#58515](https://github.com/prettier/angular-html-parser/issues/58515)) ([6338cb7](https://github.com/prettier/angular-html-parser/commit/6338cb7b3b581bcc51ed156d0c67e07eac1f7fd2))
* **compiler-cli:** incorrectly generating relative file paths on case-insensitive platforms ([#58150](https://github.com/prettier/angular-html-parser/issues/58150)) ([fb44323](https://github.com/prettier/angular-html-parser/commit/fb44323c51da5a86853aafd8a70ce0c25d6c0d7f))
* **compiler-cli:** make the unused imports diagnostic easier to read ([#58468](https://github.com/prettier/angular-html-parser/issues/58468)) ([c0738c9](https://github.com/prettier/angular-html-parser/commit/c0738c90c3e148a204b61f553b5f563e16fa989f))
* **compiler-cli:** report individual diagnostics for unused imports ([#58589](https://github.com/prettier/angular-html-parser/issues/58589)) ([086cb2c](https://github.com/prettier/angular-html-parser/commit/086cb2c40e2dcbdf831657d7ed3b3e98acf515ae))
* **compiler-cli:** report when NgModule imports or exports itself ([#58231](https://github.com/prettier/angular-html-parser/issues/58231)) ([d0c74f3](https://github.com/prettier/angular-html-parser/commit/d0c74f3891eed2feae913256ab15ac1e7435c379)), closes [#58224](https://github.com/prettier/angular-html-parser/issues/58224)
* **compiler:** `this.a` should always refer to class property `a` ([#55183](https://github.com/prettier/angular-html-parser/issues/55183)) ([09f589f](https://github.com/prettier/angular-html-parser/commit/09f589f0006f4b428b675b83c12c0dc8ebb7e45f)), closes [#55115](https://github.com/prettier/angular-html-parser/issues/55115)
* **compiler:** add more specific matcher for hydrate never block ([#58360](https://github.com/prettier/angular-html-parser/issues/58360)) ([992410e](https://github.com/prettier/angular-html-parser/commit/992410e928f15308edb37a165a6b59d2c94c30ba)), closes [#58358](https://github.com/prettier/angular-html-parser/issues/58358)
* **compiler:** add multiple :host and nested selectors support ([#57796](https://github.com/prettier/angular-html-parser/issues/57796)) ([e8d1944](https://github.com/prettier/angular-html-parser/commit/e8d1944999e1fdfbd67630d475334c0d7f41a0eb))
* **compiler:** allow combinators inside pseudo selectors ([#57796](https://github.com/prettier/angular-html-parser/issues/57796)) ([82144b6](https://github.com/prettier/angular-html-parser/commit/82144b6d63d072d112d1a7f4dcc018a1d64bb994))
* **compiler:** avoid having to duplicate core environment ([#58444](https://github.com/prettier/angular-html-parser/issues/58444)) ([21adbba](https://github.com/prettier/angular-html-parser/commit/21adbba78454f478cd66fcba5d68475b035f6437))
* **compiler:** control flow nodes with root at the end projected incorrectly ([#58607](https://github.com/prettier/angular-html-parser/issues/58607)) ([c421ffd](https://github.com/prettier/angular-html-parser/commit/c421ffdbfbf064c7d67da7296fa2f72103345cd0))
* **compiler:** fix `:host` parsing in pseudo-selectors ([#58681](https://github.com/prettier/angular-html-parser/issues/58681)) ([70e800e](https://github.com/prettier/angular-html-parser/commit/70e800ecec6b53f1ea93792ed576617eb32b343b))
* **compiler:** fix comment typo ([#57796](https://github.com/prettier/angular-html-parser/issues/57796)) ([292ea47](https://github.com/prettier/angular-html-parser/commit/292ea4714fb7e76cf1748d2f9059991e05c42574))
* **compiler:** fix multiline selectors ([#58681](https://github.com/prettier/angular-html-parser/issues/58681)) ([549a00d](https://github.com/prettier/angular-html-parser/commit/549a00d18b9060b7bae35a715e233021ef34a39a)), closes [#58399](https://github.com/prettier/angular-html-parser/issues/58399)
* **compiler:** fix parsing of the :host-context with pseudo selectors ([#57796](https://github.com/prettier/angular-html-parser/issues/57796)) ([69529d8](https://github.com/prettier/angular-html-parser/commit/69529d8873fbd7888ab68fddc6e7c654c5065764))
* **compiler:** handle typeof expressions in serializer ([#58217](https://github.com/prettier/angular-html-parser/issues/58217)) ([a3cb530](https://github.com/prettier/angular-html-parser/commit/a3cb530d846bf4d15802b9f42b6dee5c9a3a08ee))
* **compiler:** ignore placeholder-only i18n messages ([#58154](https://github.com/prettier/angular-html-parser/issues/58154)) ([ba43408](https://github.com/prettier/angular-html-parser/commit/ba4340875ac8e338ff1390fc7897eecc704ef7c5))
* **compiler:** preserve attributes attached to :host selector ([#57796](https://github.com/prettier/angular-html-parser/issues/57796)) ([2374b87](https://github.com/prettier/angular-html-parser/commit/2374b87b643e0373f85cf126d4b01b2fff785f64))
* **compiler:** resolve `:host:host-context(.foo)` ([#58681](https://github.com/prettier/angular-html-parser/issues/58681)) ([58a84b2](https://github.com/prettier/angular-html-parser/commit/58a84b2f79cb5c550d280fa64626c3bf762e9143))
* **compiler:** scope :host-context inside pseudo selectors, do not decrease specificity ([#57796](https://github.com/prettier/angular-html-parser/issues/57796)) ([46a6324](https://github.com/prettier/angular-html-parser/commit/46a6324c82a41b69c16a4c8c9f3fc52d1ecf6917))
* **compiler:** transform chained pseudo-selectors ([#58681](https://github.com/prettier/angular-html-parser/issues/58681)) ([9587437](https://github.com/prettier/angular-html-parser/commit/9587437e60d5c1542c11a037d7be203439b1636a)), closes [#58226](https://github.com/prettier/angular-html-parser/issues/58226)
* **compiler:** transform pseudo selectors correctly for the encapsulated view ([#57796](https://github.com/prettier/angular-html-parser/issues/57796)) ([bc5f117](https://github.com/prettier/angular-html-parser/commit/bc5f1175e9f39dfa2699c4de19ee9af4ce4b50d1)), closes [#45686](https://github.com/prettier/angular-html-parser/issues/45686)
* **core:** avoid breaking change with apps using rxjs 6.x ([#58341](https://github.com/prettier/angular-html-parser/issues/58341)) ([c7342be](https://github.com/prettier/angular-html-parser/commit/c7342bec243e73088462bdb4e00b3d9dd5f04424))
* **core:** avoid slow stringification when checking for duplicates in dev mode ([#58521](https://github.com/prettier/angular-html-parser/issues/58521)) ([90978de](https://github.com/prettier/angular-html-parser/commit/90978de98bbda3b5c600857ac1ca46a1ee61119b)), closes [#58509](https://github.com/prettier/angular-html-parser/issues/58509)
* **core:** clean up afterRender after it is executed ([#58119](https://github.com/prettier/angular-html-parser/issues/58119)) ([67db430](https://github.com/prettier/angular-html-parser/commit/67db4305c2261625fd54d284c29e94e26cb19488))
* **core:** clean up event contract once hydration is done ([#58174](https://github.com/prettier/angular-html-parser/issues/58174)) ([4df352b](https://github.com/prettier/angular-html-parser/commit/4df352b77e5d11e12e2591703c17ad9b4056acb4))
* **core:** correctly clear template HMR internal renderer cache ([#58724](https://github.com/prettier/angular-html-parser/issues/58724)) ([d33af5c](https://github.com/prettier/angular-html-parser/commit/d33af5cba6df0903826a9cf8c1b7a6d54d959016))
* **core:** correctly perform lazy routes migration for components with additional decorators ([#58796](https://github.com/prettier/angular-html-parser/issues/58796)) ([21f757c](https://github.com/prettier/angular-html-parser/commit/21f757c1c43c12169ad2999877306c965478ae49)), closes [#58793](https://github.com/prettier/angular-html-parser/issues/58793)
* **core:** fixes issues with control flow and incremental hydration ([#58644](https://github.com/prettier/angular-html-parser/issues/58644)) ([292d819](https://github.com/prettier/angular-html-parser/commit/292d819e92124b150108a03e8d0711dce1f8be2c))
* **core:** make component id generation more stable between client and server builds ([#58813](https://github.com/prettier/angular-html-parser/issues/58813)) ([834c7c3](https://github.com/prettier/angular-html-parser/commit/834c7c3ccc5f74b4e97e4ab08be87f83f09c1867)), closes [#58713](https://github.com/prettier/angular-html-parser/issues/58713)
* **core:** prevent errors on contract cleanup ([#58614](https://github.com/prettier/angular-html-parser/issues/58614)) ([f2bda8e](https://github.com/prettier/angular-html-parser/commit/f2bda8e3fc60f362c35a5b99917fce94d59dcc3b))
* **core:** Prevents race condition of cleanup for incremental hydration ([#58722](https://github.com/prettier/angular-html-parser/issues/58722)) ([bd08d1d](https://github.com/prettier/angular-html-parser/commit/bd08d1ddacbf87acd23ee6e3531696a1a61fddef)), closes [#58690](https://github.com/prettier/angular-html-parser/issues/58690)
* **core:** Prevents trying to trigger incremental hydration on CSR ([#58366](https://github.com/prettier/angular-html-parser/issues/58366)) ([acd4f80](https://github.com/prettier/angular-html-parser/commit/acd4f80737d982b388a39b61984c011b245d8dca)), closes [#58359](https://github.com/prettier/angular-html-parser/issues/58359)
* **core:** resolve forward-referenced host directives during directive matching ([#58492](https://github.com/prettier/angular-html-parser/issues/58492)) ([4ef11c9](https://github.com/prettier/angular-html-parser/commit/4ef11c987de2c155f711af04d1650719f00a204d)), closes [#58485](https://github.com/prettier/angular-html-parser/issues/58485)
* **devtools:** avoid duplicate dependencies in injected services ([#57564](https://github.com/prettier/angular-html-parser/issues/57564)) ([1e50374](https://github.com/prettier/angular-html-parser/commit/1e50374d75821cabf4e13cbe59611e8c1ae7ae8c))
* **docs-infra:** reduce `margin-block-start` from doc anchor headers ([#58431](https://github.com/prettier/angular-html-parser/issues/58431)) ([f04e606](https://github.com/prettier/angular-html-parser/commit/f04e6063ae808a1d29fbfab1003b536a4e7f8794))
* **docs-infra:** retain `function` keyword in API definitions ([#58561](https://github.com/prettier/angular-html-parser/issues/58561)) ([c2a9b75](https://github.com/prettier/angular-html-parser/commit/c2a9b7504521d82a6c9c6a963971ab6561474340))
* **docs-infra:** update search provider link ([#58542](https://github.com/prettier/angular-html-parser/issues/58542)) ([637126c](https://github.com/prettier/angular-html-parser/commit/637126cf6f94ead9e6df397037bb2476b61a6726))
* **forms:** fix FormRecord type inference ([#50750](https://github.com/prettier/angular-html-parser/issues/50750)) ([18b6f33](https://github.com/prettier/angular-html-parser/commit/18b6f3339f46b37ee67fce2fa8a900cc73b2f23c))
* **forms:** work around TypeScript 5.7 issue ([#58731](https://github.com/prettier/angular-html-parser/issues/58731)) ([4a18dc0](https://github.com/prettier/angular-html-parser/commit/4a18dc03a1491a028e3cd8d8b7e5b4e6c3337a5e))
* **language-service:** add fix for individual unused imports ([#58719](https://github.com/prettier/angular-html-parser/issues/58719)) ([dcd27d7](https://github.com/prettier/angular-html-parser/commit/dcd27d7921a3b502a96aa4cbbc9630001af3fb13))
* **language-service:** allow fixes to run without template info ([#58719](https://github.com/prettier/angular-html-parser/issues/58719)) ([f5b2b58](https://github.com/prettier/angular-html-parser/commit/f5b2b58b3bd0f6f26a3808eab4d88711f17b7c42))
* **localize:** Adding  arb format to the list of valid formats in the localization extractor cli ([#58287](https://github.com/prettier/angular-html-parser/issues/58287)) ([d16a609](https://github.com/prettier/angular-html-parser/commit/d16a609f5051450913f01ab493de512782f35c1a)), closes [#58286](https://github.com/prettier/angular-html-parser/issues/58286)
* **migrations:** add outputs migration to combined shorthand ([#58318](https://github.com/prettier/angular-html-parser/issues/58318)) ([42607bf](https://github.com/prettier/angular-html-parser/commit/42607bf0f28a2421a0d41809485c09dca26ea599))
* **migrations:** do not migrate next calls in template if not an EventEmitter ([#58631](https://github.com/prettier/angular-html-parser/issues/58631)) ([2eb4afe](https://github.com/prettier/angular-html-parser/commit/2eb4afe2b39892610193f0f3443dc668895ca0a0)), closes [#58630](https://github.com/prettier/angular-html-parser/issues/58630)
* **migrations:** fix provide-initializer migration when using useFactory ([#58518](https://github.com/prettier/angular-html-parser/issues/58518)) ([1fe001e](https://github.com/prettier/angular-html-parser/commit/1fe001e18b971b48f84cabcd858f7dece8f05139))
* **migrations:** flip the default standalone flag in route-lazy-loading migration ([#58474](https://github.com/prettier/angular-html-parser/issues/58474)) ([6819d6a](https://github.com/prettier/angular-html-parser/commit/6819d6abf3381383d3b5e25e04d1866b7438fca8))
* **migrations:** handle parameters with initializers in inject migration ([#58769](https://github.com/prettier/angular-html-parser/issues/58769)) ([18991d3](https://github.com/prettier/angular-html-parser/commit/18991d3210e635dad6a50cda6088d886980aa58a))
* **migrations:** include the output migration in the defaults of the signal migration ([#58635](https://github.com/prettier/angular-html-parser/issues/58635)) ([579f613](https://github.com/prettier/angular-html-parser/commit/579f613a5811530c1824dd90642a2ef44ba568b3))
* **migrations:** inject migration always inserting generated variables before super call ([#58393](https://github.com/prettier/angular-html-parser/issues/58393)) ([4434f3c](https://github.com/prettier/angular-html-parser/commit/4434f3c7a1c843751877738129d4b7e049a14cf9))
* **migrations:** inject migration not inserting generated code after super call in some cases ([#58393](https://github.com/prettier/angular-html-parser/issues/58393)) ([b98400f](https://github.com/prettier/angular-html-parser/commit/b98400f5824a909b7cd187d946ff48d0845d99ba))
* **migrations:** Mark hoisted properties as removed in inject migration ([#58804](https://github.com/prettier/angular-html-parser/issues/58804)) ([3fc14ec](https://github.com/prettier/angular-html-parser/commit/3fc14ecc81c5fdf20ddbdf03234708d19f7310dd))
* **migrations:** migrate more .next output usages ([#58282](https://github.com/prettier/angular-html-parser/issues/58282)) ([00e2001](https://github.com/prettier/angular-html-parser/commit/00e20013512f75327e5644ad5ac7829fc0e866d4))
* **migrations:** properly bundle shared compiler code into migrations ([#58515](https://github.com/prettier/angular-html-parser/issues/58515)) ([8d5d5f8](https://github.com/prettier/angular-html-parser/commit/8d5d5f80b3024560356ada328e84e489d903dd38))
* **migrations:** properly migrate output aliases ([#58411](https://github.com/prettier/angular-html-parser/issues/58411)) ([3161360](https://github.com/prettier/angular-html-parser/commit/31613608521e7dd06fc4b5226cc303ac23010053))
* **migrations:** properly replace imports across files ([#58414](https://github.com/prettier/angular-html-parser/issues/58414)) ([db7ed20](https://github.com/prettier/angular-html-parser/commit/db7ed20d7b88457bb929ea0f9fdd4853a2f9c5f2))
* **migrations:** properly resolve tsconfig paths on windows ([#58137](https://github.com/prettier/angular-html-parser/issues/58137)) ([c1aa411](https://github.com/prettier/angular-html-parser/commit/c1aa411cf13259d991c8f224a2bafc3e9763fe8d)), closes [#58132](https://github.com/prettier/angular-html-parser/issues/58132)
* **migrations:** replace removed NgModules in tests with their exports ([#58627](https://github.com/prettier/angular-html-parser/issues/58627)) ([89256e6](https://github.com/prettier/angular-html-parser/commit/89256e6868164f14cbf9630c2928962e458d74ba)), closes [#57684](https://github.com/prettier/angular-html-parser/issues/57684)
* **platform-browser:** correctly add external stylesheets to ShadowDOM components ([#58482](https://github.com/prettier/angular-html-parser/issues/58482)) ([c22b5ac](https://github.com/prettier/angular-html-parser/commit/c22b5accdd083f3bdc4141431cece196f0e33112))
* **platform-server:** destroy `PlatformRef` when error happens during the `bootstrap()` phase ([#58112](https://github.com/prettier/angular-html-parser/issues/58112)) ([9e82559](https://github.com/prettier/angular-html-parser/commit/9e82559de4e99a1aedf645a05b01fc08d3f4b1b1)), closes [#58111](https://github.com/prettier/angular-html-parser/issues/58111)
* **router:** remove setter for `injector` on `OutletContext` ([#58343](https://github.com/prettier/angular-html-parser/issues/58343)) ([bad3651](https://github.com/prettier/angular-html-parser/commit/bad36519f221bc84f84aa739b5582e5f7bb2a337)), closes [#56798](https://github.com/prettier/angular-html-parser/issues/56798)
